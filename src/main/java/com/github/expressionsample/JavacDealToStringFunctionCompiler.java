...
//        Iterable<? extends JavaFileObject> compilationUnits = Arrays.asList(jsfs);
        ...
        jfiles.add(new CharSequenceJavaFileObject("GeneratedDealToStringFunction", FUNCTION));
        
        final boolean isCompiled = compiler.getTask(null, null, null, null, null, jfiles).call();
        ...
        try {
            ...
            return (DealToStringFunction) fileManager.getClassLoader(null)
